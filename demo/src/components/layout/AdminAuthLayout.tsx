...
const AdminAuthLayout = ({ children, title, subtitle }: AdminAuthLayoutProps) => {
    ...
    <div className="min-h-screen flex relative">
      ...
      <div className="hidden lg:flex lg:flex-1 items-center justify-center bg-primary/5 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-center space-y-4 px-8">
          ...
          <p className="text-sm text-muted-foreground">Acesso restrito. Gerencie a plataforma, usuários e configurações.</p>
        </div>
      </div>
    </div>
  );
